...
if __name__ == "__main__":
    ...
    with open(train_full_mixed_features_path, mode='r') as fd_train_full_mf, \
        ...
        for line in fd_train_full_mf:
            ...
            train_full_mixed_features_y.append(splitted[1])
        ...
        for line in fd_train_full_no:
            ...
            train_full_number_occurrences_y.append(splitted[1])
        ...
        for line in fd_train_full_oi:
            ...
            train_full_ordered_instructions_y.append(splitted[1])
        ...
        for line in fd_train_partial_mf:
            ...
            train_partial_mixed_features_y.append(splitted[1])
        ...
        for line in fd_train_partial_no:
            ...
            train_partial_number_occurrences_y.append(splitted[1])
        ...
        for line in fd_train_partial_oi:
            ...
            train_partial_ordered_instructions_y.append(splitted[1])
        ...
        for line in fd_test_full_mf:
            ...
            test_full_mixed_features_y.append(splitted[1])
        ...
        for line in fd_test_full_no:
            ...
            test_full_number_occurrences_y.append(splitted[1])
        ...
        for line in fd_test_full_oi:
            ...
            test_full_ordered_instructions_y.append(splitted[1])
        ...
        for line in fd_test_partial_mf:
            ...
            test_partial_mixed_features_y.append(splitted[1])
        ...
        for line in fd_test_partial_no:
            ...
            test_partial_number_occurrences_y.append(splitted[1])
        ...
        for line in fd_test_partial_oi:
            ...
            test_partial_ordered_instructions_y.append(splitted[1])
